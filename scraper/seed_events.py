...
def get_seed_events():
    ...
    events = [
        ...
        # ═══════════════════════════════════════════════════════════════════
        {
            ...
            "time": "12:00 PM",
            "price": "Free",
            "categories": ["classical", "performance", "lecture"],
        ...
        # ═══════════════════════════════════════════════════════════════════
        {
            "title": "The Rise and Fall of the Mob in Philadelphia",
            "date_start": "2026-04-02",
            "date_end": "2026-04-02",
            "venue": "Urban Saloon",
            "source": "Profs and Pints",
            "source_url": "https://www.profsandpints.com/philadelphia",
            "link": "https://www.ticketleap.events/tickets/profsandpints/profs-and-pints-philadelphia-rise-fall-mob",
            "price": "$13.50",
            "categories": ["lecture"],
            "description": "A lively talk over drinks about the dramatic history of organized crime in Philadelphia — from Prohibition-era bootlegging to modern-day prosecutions. Presented by a university professor at a neighborhood bar.",
            "time": "6:00 PM",
        },
        {
            ...
            "source": "Profs and Pints",
            "source_url": "https://www.profsandpints.com/philadelphia",
            "link": "https://www.ticketleap.events/tickets/profsandpints/profs-and-pints-philadelphia-science-happiness",
            "price": "$13.50",
            "categories": ["lecture", "science"],
            "description": "What does research say about what truly makes us happy? A psychology professor breaks down the latest findings on well-being, gratitude, and the pursuit of the good life — all over a pint.",
            "time": "6:00 PM",
        },
        {
            ...
            "source": "Profs and Pints",
            "source_url": "https://www.profsandpints.com/philadelphia",
            "link": "https://www.ticketleap.events/tickets/profsandpints/profs-and-pints-philadelphia-ai-future-work",
            "price": "$13.50",
            "categories": ["lecture", "science"],
            "description": "How will artificial intelligence reshape the job market? A technology researcher explores the economic and social implications of AI automation, and what it means for workers today.",
            "time": "6:00 PM",
        },
        # ═══════════════════════════════════════════════════════════════════
        # SOFAR SOUNDS
        # ═══════════════════════════════════════════════════════════════════
        {
            "title": "Sofar Sounds Philadelphia: Secret Concert",
            "date_start": "2026-04-05",
            "date_end": "2026-04-05",
            "venue": "Secret Venue (Sofar Sounds)",
            "source": "Sofar Sounds Philadelphia",
            "source_url": "https://www.sofarsounds.com/cities/philadelphia",
            "link": "https://www.sofarsounds.com/cities/philadelphia",
            "price": "$25",
            "categories": ["concert", "performance"],
            "description": "Intimate live music in a secret Philadelphia location, revealed 24 hours before the show. Three emerging artists perform acoustic sets in an unplugged, phone-free environment. Sofar reimagines the live music experience.",
            "time": "7:30 PM",
        },
        {
            "title": "Sofar Sounds Philadelphia: April Session",
            "date_start": "2026-04-19",
            "date_end": "2026-04-19",
            "venue": "Secret Venue (Sofar Sounds)",
            "source": "Sofar Sounds Philadelphia",
